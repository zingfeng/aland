...
<section class="test-reading test-reading-review">
        ...
        <div class="row no-gutters">
            ...
            <div id="col2" class="col col_gutter answer">
                ...
                <div class="choose_answer">
                    <?php for ($i=0; $i < 3; $i++) { ?>
                    <div class="item-test-reading-review row -border-margin-bottom">
                        <div class="col-1 mr-3">
                            <div class="form-answer__number-answer left_input_100">
                                3
                            </div>
                        </div>
                        <div class="col-10 custom-col choose_answer__review-your-answer">
                        <span class="your-answer text-uppercase -false">not given  <i class="fa fa-times" aria-hidden="true"></i></span>
                       <span class="real-answer text-uppercase">&nbsp;-&nbsp;true</span>
                        <p class="question">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum magnam distinctio possimus molestias cum. Dolorem ut laudantium debitis neque voluptatem.
                        </p>
                        </div>
                    </div>
                    <?php } ?>

                    <div class="item-test-reading-review row">
                        <div class="col-1 mr-3">
                            <div class="form-answer__number-answer left_input_100">
                                3
                            </div>
                        ...
                        <div class="col-10 custom-col choose_answer__review-your-answer">
                        <span class="your-answer text-uppercase -true">not given  <i class="fa fa-check" aria-hidden="true"></i></span>
                       <!-- <span class="real-answer text-uppercase">&nbsp;-&nbsp;true</span> -->
                        <p class="question">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum magnam distinctio possimus molestias cum. Dolorem ut laudantium debitis neque voluptatem.
                        </p>
                ...
                <div class="question_title mt-5">Question 8 - 16</div>
                <p>Do the following statements agree with the information given in Reading Passage 1? In boxes 1-7 on
                <div class="choose_answer">
                    <?php for ($i=0; $i < 3; $i++) { ?>
                    <div class="item-test-reading-review  row">
                       ...
                       <span class="real-answer text-uppercase">&nbsp;-&nbsp;true</span>
                        <p class="question">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Earum magnam distinctio.
                        </p>
                        </div>
                    </div>
                    <?php } ?>
