    ...
    <div class="container background-test">
        ...
        <div class="row no-gutters">
            <div id="col1" class="col col_gutter read">
                ...
                <div class="description">You should spend about 20 minutes on Questions 1-13, which are based on Reading Passage 1 below.</div>
            ...
            <div id="col2" class="col col_gutter answer">
                ...
                <p>Do the following statements agree with the information given in Reading Passage 1? In boxes 1-7 on your answer sheet, write</p>
