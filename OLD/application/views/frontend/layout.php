...
//             echo trim(strtolower($this->uri->segment(1)));
    ...
    <style>
        ...
        .detail_tin .noi_dung ul li{list-style: disc}
        .detail_tin .noi_dung a{color: #337ab7}
    </style>
</head>
    ...
    <header id="header" class="section header">
        ...
        <div class="my_user">
            ...
            <?php } else {?>
                ...
                <a href="javascript:;" class="ava avatar-header" onclick="showUserMenu()" style="width: 24px; height: 24px; float: left;">
