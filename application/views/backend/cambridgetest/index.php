...
<div id="test_lists" class="page-lists">
						...
						<table class="table table-striped jambo_table table-bordered">
							<thead id="checkbox_all">
								<tr class="headings">
									...
									<th class="column-title" width="160px">Thêm câu hỏi</th>
									<th class="column-title" width="160px">Danh sách câu hỏi</th>
							...
							<tbody id="checkbox_list">
								...
								<tr>
									...
									<td align="center">
										...
										<a title="Thêm chuyên đề" href="<?php echo SITE_URL; ?>/testcambridge/question_add?testid=<?php echo $row['test_id']; ?>">
											Thêm
										</a>
										<?php } ?>
									</td>
									<td>
										...
										<a title="Thêm chuyên đề" href="<?php echo SITE_URL; ?>/testcambridge/question_index/<?php echo $row['test_id']; ?>">
											Xem
										</a>
										<?php } ?>
									</td>									
									...
									<td class="action last" align="center">
										...
										<a data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line("common_edit"); ?>" href="<?php echo SITE_URL; ?>/testcambridge/edit/<?php echo $row['test_id']; ?>">
	...
	<div class="page-title scroll_action">
		<div class="title_left">
			...
			<a class="btn btn-primary" href="<?php echo SITE_URL; ?>/testcambridge/add">Thêm bài test</a>
			<?php } ?>
			<?php if ($pDelete) { ?>
