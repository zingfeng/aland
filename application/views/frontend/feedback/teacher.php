                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label><input id="teacher_giaotiep_insert"  name="teacher_giaotiep_insert" type="checkbox" value="">GIAO TIẾP</label>
                                </div>
                            </div>

                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label><input id="teacher_toeic_insert" name="teacher_toeic_insert"  type="checkbox" value="">TOEIC</label>
                                </div>
                            </div>

                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label><input id="teacher_ielts_insert" name="teacher_ielts_insert" type="checkbox" value="">IELTS</label>
                                </div>
                            </div>

                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label><input id="teacher_aland_insert" name="teacher_aland_insert" type="checkbox" value="">ALAND</label>
                                </div>
                            </div>
