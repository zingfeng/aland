                    ...
                    <div>
                        ...
                        <?php
                            if (isset($_GET['type'])){
                                ...
                                <div class="checkbox">
                                    <label><input class="filter-type"  type="checkbox" value="toiec" <?php if (in_array('toiec',$type_filter_live)){ echo ' checked '; }?>>Toeic</label>
                                </div>
                                <div class="checkbox">
                            ...
                            <?php
                                ...
                                <div class="checkbox">
                                    <label><input class="filter-type"  type="checkbox" value="toiec" checked>Toeic</label>
                                </div>
                                <div class="checkbox">
            ...
            <table id="dtClassList" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                foreach ($class_info as $mono_class_info) { ?>
                    <tr>
                        ...
                        <td><?php echo $location_access[$mono_class_info['id_location']]; ?></td>
                        <td><?php echo $mono_class_info['more_info']; ?></td>
                        <td><?php echo $mono_class_info['number_feedback']; ?></td>
