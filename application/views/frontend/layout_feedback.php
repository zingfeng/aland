...
<head>
    ...
    <script src="theme/frontend/default/js/feedback.js" ></script>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="/feedback/dashboard"><a href="/feedback">Dashboard <span class="sr-only">(current)</span></a></li>
                <li><a href="/feedback/class_">Class</a></li>
                <li><a href="/feedback/teacher">Teacher</a></li>
...
<!--                <li><a href="/feedback/dashboard">About Us</a></li>-->
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Hi, <?php  if(isset($_SESSION['username'])) echo $_SESSION['username']; ?>   <span class="caret"></span></a>
