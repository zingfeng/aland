            ...
            <div class="col-4">
                <div class="passage-control">
                    <?php foreach ($arrQuestion as $i => $question) {?>
                        ...
                        <?php } else { ?>
                            <button data-ci="<?php echo $i?>" class="btn btn-danger btn-sm button-next-finish-section-view-mobile submit_answer_result" type="submit" style="display: none">Nộp bài</button> 
                        <?php } ?>
                    <?php }?>
                </div>
            </div>
